...
class CentralCorridor(Scene):
    def enter(self):
        print(dedent("""
              ...
              surviving member and your last mission it to get the neutro destruct bomb from the Weapons Armory, put it 
              in the bridge, and blow the ship up after getting into an escape pod.

              You're running down the  central cooridor to the Weapons Armory when a Gothon jumps out, red scaly skin, 
        ...
        if action == "shoot!":
            print(dedent("""
                             Quick on the draw you yank out your blaster and fire it a t the Gothon. His clown costume 
                             is flowing and moving around his body, which throws off your aim. Your laser hits his 
                             costumer but misses him entirely. This completely ruins his brand new costume his mother 
                             bought him, which makes him fly into an insane rage and blast you repeatedly in the face 
            ...
            print(dedent("""
                                  Lucky for you they mde you learn Gothon insults in the academy. you tell the one 
                                  Gothon joke you know: Lbhe zbgure vf fb sng, jura fur fvgg nebhaq gur ubjf. 
                                  fir fvgf nebhaq gu ubjfr. The Gothon stops, tries not to laugh, then busts our 
                                  laughing and can't move. While he's laughing you run up and shoot him square in the
...
class LaserWeaponArmory(Scene):
    def enter(self):
        print(dedent("""
            ...
            It's dead quiet, too quiet. You stand up and run to the far side of the room and find the neutron bomb in
             its container. There's a keypad lock on the box and you need the code to get the bomb out. If you get the
              code wrong 10 times then the lock closes forever and you can't get the bomb. The code is 3 digits.
            """))
        ...
        if guess == code:
            ...
            print(dedent("""
                            The lock buzzes one last time and then you hear a sickening melting sound as the mechanizm
                         is fused together. You decide to sit there, and finally the Gothns blow up the ship from
...
class TheBridge(Scene):
    def enter(self):
        ...
        if action == "throw the bomb":
            print(dedent("""
            In a panic you throw the bomb at the group of Gothons and make a leap for the door. Right as you drop it a 
             Gothon shoots you right in the back killing you. As you die you see another Gothon frantically try to 
            ...
            print(dedent("""
                    ...
                    sweat. You inch backward to the door, open it, and then carefully place the bomb under the floor,
                     pointing your blaster at it. You then jump back through the door, punch the close button and blast
                      the lock so the Gothons can't get out. Now that the bomb is placed you run to the escape pod to
...
class EscapePod(Scene):
    def enter(self):
        ...
        if int(guess) != good_pod:
            ...
            print(dedent(f"""
                    You jump into pod {guess} and hit the eject button. The pod easily slides out into space heading to
                     the planet below. As it flies to the planet, you look back and see your ship implode then explode
                      like a bright start, taking out the Gothon ship at the same time. You won!!!"""))
            return 'finished'
